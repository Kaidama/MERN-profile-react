import { Sanitizers } from 'express-validator/src/middlewares/node_modules/express-validator/src/chain/sanitizers';
import { Validators } from 'express-validator/src/middlewares/node_modules/express-validator/src/chain/validators';
import { DynamicMessageCreator, Location } from 'express-validator/src/middlewares/node_modules/express-validator/src/base';
import { Optional } from 'express-validator/src/middlewares/node_modules/express-validator/src/context';
...
export declare function checkSchema(schema: Schema, defaultLocations?: Location[]): import("express-validator/src/middlewares/node_modules/express-validator/src/chain").ValidationChain[];
export {};
